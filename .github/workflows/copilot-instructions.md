...
If task is not totally clear, ASK CLARIFYING QUESTIONS UNTIL IT IS!
...
Blazor WASM +  .NET 10 API (Azure App Service (BLAZOR WASM + .NET core API in same App Service)
