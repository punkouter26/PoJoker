...
Unified Identity: Use Po{SolutionName} as the master prefix for all namespaces, Azure Resource Groups, and resources (e.g., PoTask1.API, rg-PoTask1-prod).
...
Create http endpoints for all main function so it can easily be tested 
